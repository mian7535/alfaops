...
void Pitch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData Pitch::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Pitch::staticMetaObject = {
    { &QwtDial::staticMetaObject, qt_meta_stringdata_Pitch,
      qt_meta_data_Pitch, &staticMetaObjectExtraData }
};
