...
HeliumPressure::HeliumPressure(QWidget *parent ):
    QwtDial(parent)
{
...
void HeliumPressure::drawScaleContents( QPainter *painter, const QPointF &, double ) const
{
